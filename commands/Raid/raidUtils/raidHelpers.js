...
async function processGlobalRaidRewards(raidBoss) {
    ...
    for (const userId of globalRaidParticipants) {
      ...
      const cardRewards = getUniformCardRewards(false, raidProgressPercentage, raidBoss);
    ...
    const summaryEmbed = new EmbedBuilder()
      ...
      .setDescription(`Raid progress was ${Math.round(raidProgressPercentage * 100)}%. Rewards have been distributed to all participants.`)
      .setColor('Green');
    return summaryEmbed;
  }
